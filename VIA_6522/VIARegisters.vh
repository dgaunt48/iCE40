...
parameter VIA_ACR_PA_LATCH_MSB			= 0;		// Port A Latch Enable
parameter VIA_ACR_PA_LATCH_LSB			= 0;
parameter VIA_ACR_PB_LATCH_MSB			= 1;		// Port B Latch Enable
parameter VIA_ACR_PB_LATCH_LSB			= 1;
parameter VIA_ACR_SRC_MSB				= 4;		// Shift Register Control
parameter VIA_ACR_SRC_LSB				= 2;
parameter VIA_ACR_TIMER2_CTRL_MSB		= 5;		// Timer 2 Control
parameter VIA_ACR_TIMER2_CTRL_LSB		= 5;
...
parameter VIA_PCR_CA1_CONTROL_MSB		= 0;		// CA1 Interrupt Control Pin
parameter VIA_PCR_CA1_CONTROL_LSB		= 0;
parameter VIA_PCR_CA2_CONTROL_MSB		= 3;		// CA2 
parameter VIA_PCR_CA2_CONTROL_LSB		= 1;
parameter VIA_PCR_CB1_CONTROL_MSB		= 4;		// CB1 Interrupt Control Pin
parameter VIA_PCR_CB1_CONTROL_LSB		= 4;
...
parameter VIA_IFR_CA2_MSB				= 0;
parameter VIA_IFR_CA2_LSB				= 0;
parameter VIA_IFR_CA1_MSB				= 1;
parameter VIA_IFR_CA1_LSB				= 1;
parameter VIA_IFR_SR_MSB				= 2;
parameter VIA_IFR_SR_LSB				= 2;
parameter VIA_IFR_CB2_MSB				= 3;
parameter VIA_IFR_CB2_LSB				= 3;
parameter VIA_IFR_CB1_MSB				= 4;
parameter VIA_IFR_CB1_LSB				= 4;
parameter VIA_IFR_T2_MSB				= 5;
parameter VIA_IFR_T2_LSB				= 5;
parameter VIA_IFR_T1_MSB				= 6;
parameter VIA_IFR_T1_LSB				= 6;
parameter VIA_IFR_IRQ_MSB				= 7;
parameter VIA_IFR_IRQ_LSB				= 7;
parameter VIA_REG_IER			= 14;				// Interrupt Enable Register
parameter VIA_IER_CA2_MSB				= 0;
parameter VIA_IER_CA2_LSB				= 0;
parameter VIA_IER_CA1_MSB				= 1;
parameter VIA_IER_CA1_LSB				= 1;
parameter VIA_IER_SR_MSB				= 2;
parameter VIA_IER_SR_LSB				= 2;
parameter VIA_IER_CB2_MSB				= 3;
parameter VIA_IER_CB2_LSB				= 3;
parameter VIA_IER_CB1_MSB				= 4;
parameter VIA_IER_CB1_LSB				= 4;
parameter VIA_IER_T2_MSB				= 5;
parameter VIA_IER_T2_LSB				= 5;
parameter VIA_IER_T1_MSB				= 6;
parameter VIA_IER_T1_LSB				= 6;
parameter VIA_IER_SET_CLR_MSB			= 7;
parameter VIA_IER_SET_CLR_LSB			= 7;
